...
private:
	...
	size_t _max_length;
	size_t _n_pairs;
	std::auto_ptr<std::vector<std::vector<Match_point> > > _pairs;
...
public:
	...
	void reserve_add_memory(unsigned int seq1_id, unsigned int seq2_id, size_t n_entries);
	 ...
	 */
	void add(unsigned int seq1_id, unsigned int seq2_id, unsigned int pos1, unsigned int pos2);
	 ...
	 */
	void add(unsigned int seq1_id, unsigned int seq2_id, unsigned int pos1, unsigned int pos2, float score);
